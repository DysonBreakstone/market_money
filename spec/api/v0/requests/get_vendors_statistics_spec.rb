...
RSpec.describe "vendor statistics" do
  ...
  describe "most popular vendor by state" do
    it "returns most popular vendors for a given state" do
      @market_1 = Market.create!(name: "Market 1", street: "One Street", city: "One City", county: "One County", state: "One State", zip: "11111", lat: "38.9169984", lon: "-77.0320505")
      @market_2 = Market.create!(name: "Market 2", street: "Two Street", city: "Two City", county: "Two County", state: "Two State", zip: "22222", lat: "38.9169984", lon: "-77.0320505")
      @market_3 = Market.create!(name: "Market 3", street: "Three Street", city: "Three City", county: "Three County", state: "Three State", zip: "33333", lat: "38.9169984", lon: "-77.0320505")
      @market_4 = Market.create!(name: "Market 4", street: "Four Street", city: "Four City", county: "Four County", state: "Four State", zip: "44444", lat: "38.9169984", lon: "-77.0320505")
      ...
      get "/api/v0/vendors", params: {state: "Five State"}
      json = JSON.parse(response.body, symbolize_names: true)
      expect(response).to have_http_status(200)
        ...
        expect(json[:data]).to all(be_a(Hash))
        expect(json[:data].count).to eq(3)
        expect(json[:data][0][:id]).to eq(@vendor_1.id.to_s)
        expect(json[:data][1][:id]).to eq(@vendor_2.id.to_s)
        expect(json[:data][2][:id]).to eq(@vendor_3.id.to_s)
    end

    it "different data to make sure it works" do
      @market_1 = Market.create!(name: "Market 1", street: "One Street", city: "One City", county: "One County", state: "One State", zip: "11111", lat: "38.9169984", lon: "-77.0320505")
      @market_2 = Market.create!(name: "Market 2", street: "Two Street", city: "Two City", county: "Two County", state: "Two State", zip: "22222", lat: "38.9169984", lon: "-77.0320505")
      @market_3 = Market.create!(name: "Market 3", street: "Three Street", city: "Three City", county: "Three County", state: "Three State", zip: "33333", lat: "38.9169984", lon: "-77.0320505")
      @market_4 = Market.create!(name: "Market 4", street: "Four Street", city: "Four City", county: "Four County", state: "Four State", zip: "44444", lat: "38.9169984", lon: "-77.0320505")
      ...
      @market_vendor_1 = MarketVendor.create!(vendor_id: @vendor_1.id, market_id: @market_1.id)
      @market_vendor_2 = MarketVendor.create!(vendor_id: @vendor_2.id, market_id: @market_1.id)
      @market_vendor_3 = MarketVendor.create!(vendor_id: @vendor_3.id, market_id: @market_1.id)
      @market_vendor_4 = MarketVendor.create!(vendor_id: @vendor_4.id, market_id: @market_1.id)
      @market_vendor_5 = MarketVendor.create!(vendor_id: @vendor_5.id, market_id: @market_1.id)
      @market_vendor_6 = MarketVendor.create!(vendor_id: @vendor_2.id, market_id: @market_2.id)
      @market_vendor_7 = MarketVendor.create!(vendor_id: @vendor_3.id, market_id: @market_2.id)
      @market_vendor_8 = MarketVendor.create!(vendor_id: @vendor_4.id, market_id: @market_2.id)
      @market_vendor_9 = MarketVendor.create!(vendor_id: @vendor_5.id, market_id: @market_2.id)
      @market_vendor_10 = MarketVendor.create!(vendor_id: @vendor_2.id, market_id: @market_3.id)
      @market_vendor_11 = MarketVendor.create!(vendor_id: @vendor_3.id, market_id: @market_3.id)
      @market_vendor_12 = MarketVendor.create!(vendor_id: @vendor_4.id, market_id: @market_3.id)
      @market_vendor_13 = MarketVendor.create!(vendor_id: @vendor_2.id, market_id: @market_4.id)
      @market_vendor_14 = MarketVendor.create!(vendor_id: @vendor_3.id, market_id: @market_4.id)
      @market_vendor_15 = MarketVendor.create!(vendor_id: @vendor_3.id, market_id: @market_5.id)

      get "/api/v0/vendors", params: {state: "Three State"}
      json = JSON.parse(response.body, symbolize_names:true)
      expect(response).to have_http_status(200)
      ...
      expect(json[:data]).to all(be_a(Hash))
      expect(json[:data].count).to eq(3)
      expect(json[:data][0][:id]).to eq(@vendor_3.id.to_s)
      expect(json[:data][1][:id]).to eq(@vendor_2.id.to_s)
      expect(json[:data][2][:id]).to eq(@vendor_4.id.to_s)
    end
  end
end